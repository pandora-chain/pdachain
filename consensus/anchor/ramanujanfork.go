...
func (p *Anchor) delayForRamanujanFork(snap *Snapshot, header *types.Header) time.Duration {
...
func (p *Anchor) blockTimeForRamanujanFork(snap *Snapshot, header, parent *types.Header) uint64 {
...
func (p *Anchor) blockTimeVerifyForRamanujanFork(snap *Snapshot, header, parent *types.Header) error {
	if p.chainConfig.IsRamanujan(header.Number) {
